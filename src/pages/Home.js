  ...
  return (
      <div className="second-row" style={{
          ...
          <div class="bottom-text">
              ...
              <NavLink to='/shopping-cart-react/products/newarrivals'><button className='push-right scale standard-btn'>Explore</button></NavLink>
          </div>
      <div className='bottom-content'>
            <div className="image-container">
              <img className='image' src={imageOne} alt='Hikers hiking in snow' />
              <p className='image-text-one'>New Arrivals</p>
              <NavLink to='/shopping-cart-react/products/newarrivals'><button className='button-one scale standard-btn'>Shop</button></NavLink>
              <img className='image' src={imageTwo} alt='Hiker sitting overlooking alpine lake' />
              <p className='image-text-two'>Hiking Gear</p>
              <NavLink to='/shopping-cart-react/products/hiking'><button className='button-two scale standard-btn'>Shop</button></NavLink>
              ...
              <NavLink to='/shopping-cart-react/products/camping'><button className='button-three scale standard-btn'>Shop</button></NavLink>
